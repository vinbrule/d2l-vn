...
project = "Đắm mình vào Học Sâu"
copyright = "2019, All authors. Licensed under Apache 2.0"
author = "Aston Zhang, Zachary C. Lipton, Mu Li, and Alexander J. Smola"
release = "0.7.0"

extensions = ["recommonmark","sphinxcontrib.bibtex","sphinxcontrib.rsvgconverter","sphinx.ext.autodoc"]
...
html_theme_options = {
    ...
    'header_links': [
        ('GitHub', 'https://github.com/aivivn/d2l-vn', True, 'fab fa-github'),('English', 'https://www.d2l.ai/', True, 'fas fa-external-link-alt'),
    ],
    'show_footer': False
}
...
latex_documents = [
    (master_doc, "d2l-vn.tex", "Đắm mình vào Học Sâu",
     author, 'manual'),
]
